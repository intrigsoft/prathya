...
public class BytecodeAnnotationScanner implements AnnotationScanner {
    ...
    private static final String REQUIREMENT_DESC = "Lcom/intrigsoft/prathya/annotations/Requirement;";
    private static final String REQUIREMENT_LIST_DESC = "Lcom/intrigsoft/prathya/annotations/Requirement$List;";
