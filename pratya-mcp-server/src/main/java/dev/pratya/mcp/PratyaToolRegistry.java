...
import dev.pratya.mcp.tools.ReadToolHandlers;
import dev.pratya.mcp.tools.ToolSchemas;
...
/**
 * Registers all 13 Pratya MCP tools on the server.
 */
public class PratyaToolRegistry {

    private final ReadToolHandlers read;
    private final WriteToolHandlers write;

    public PratyaToolRegistry(PratyaServerConfig config) {
