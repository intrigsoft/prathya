...
/**
 * Parses CLI arguments for the Pratya MCP server.
 */
public class PratyaServerConfig {

    private Path contractFile;
    private Path testClassesDir;
    private Path classesDir;

    private PratyaServerConfig() {}

    public static PratyaServerConfig parse(String[] args) {
        PratyaServerConfig config = new PratyaServerConfig();
